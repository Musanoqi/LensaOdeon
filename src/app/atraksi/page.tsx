              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-stone-200 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between h-full group">
                ...
                <div className="p-6 pt-0">
                  <Link
                    ...
                    className="w-full inline-flex items-center justify-between text-xs font-semibold text-stone-700 bg-stone-50 hover:bg-[#580A14] hover:text-white border border-stone-200 py-2.5 px-4 rounded-xl transition-all duration-200"
                  >
