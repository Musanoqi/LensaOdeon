...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#3D060D] text-amber-50/90 pt-16 pb-8 border-t border-amber-950">
      <div className="max-w-4xl mx-auto text-center px-4 mb-16">
        <span className="text-xs tracking-widest text-amber-300 uppercase font-semibold">
          {t.ctaLabel}
        </span>
        <h2 className="font-serif text-2xl md:text-4xl text-amber-100 font-bold mt-2 mb-4">
          {t.ctaTitle1} <br className="hidden sm:inline" />
          <span className="italic font-normal">{t.ctaTitle2}</span>
        </h2>
        <p className="text-sm text-amber-200/70 max-w-xl mx-auto">{t.ctaDesc}</p>
      </div>

      <hr className="border-amber-900/40 max-w-7xl mx-auto mb-12" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        <div className="space-y-3">
          ...
          <p className="text-xs text-amber-200/60 leading-relaxed">{t.brandDesc}</p>
        </div>

        <div>
          <h3 className="font-semibold text-amber-200 uppercase text-xs tracking-wider mb-3">
            {t.navTitle}
          </h3>
          <ul className="space-y-2 text-xs text-amber-200/70">
            ...
            <li>
              <Link href="/atraksi" className="hover:text-amber-100 transition-colors">
                {t.navAttraction}
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-xs text-amber-200/70 mb-3 leading-relaxed">{t.address}</p>
          <a
            href="https://maps.app.goo.gl/KwzdYYTGvgw4eEnZ7"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-xs bg-amber-950/80 hover:bg-amber-900 border border-amber-800 text-amber-200 px-3 py-1.5 rounded-md transition-colors"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-amber-950 text-center text-xs text-amber-200/40">
